...
from ..util.pdb3d import dihedral_angle, dist, sqrdist, vectors2rotation_matrix, axis_angle2rotation_matrix
from ..util.residue import Residue, ResidueList
from ..util.residue import is_residue_consecutive as is_consecutive
from ..util.pdb import Atom, residueCode
from ..util.ali import Ali
...
def iterate_database(dbdir, loop_length, esst, anchor, sequence, strict_rmsd_cutoff, score_cutoff):
  ...
  """
  I will need to pass the database here instead of loading everytime
  """
